...
namespace Mvc.StorageAccount.Demo.Services
{
    public class BlobStorageService : IBlobStorageService
    {
        ...
        public BlobStorageService(IConfiguration configuration, BlobServiceClient blobServiceClient)
        {
            ...
            //this.container = new BlobContainerClient(_configuration["StorageConnectionString"], containerName);
            //container.CreateIfNotExists();
            _blobServiceClient = blobServiceClient;
            this.container = _blobServiceClient.GetBlobContainerClient(containerName);
        }
